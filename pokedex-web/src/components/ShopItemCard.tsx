...
export const ShopItemCard = React.memo(({ item, count, isDark, onBuy, shouldPlay }: ShopItemCardProps) => {
    ...
    return (
        <View style={[styles.itemCard, isDark && styles.itemCardDark] as any}>
            ...
            <View style={[styles.cardBackground, { backgroundColor: isSpecialEffect ? 'transparent' : cardBackground }] as any}>
                ...
                {count > 0 && <View style={[styles.ownedBadge, { top: 12, right: 12 }] as any}><Text style={styles.ownedText}>x{count}</Text></View>}
...
const styles = StyleSheet.create({
    ...
    categoryText: { color: '#fff', fontSize: 10, fontWeight: '700', letterSpacing: '0.5px' },
    ...
    cardTypeContainer: { flexDirection: 'row', gap: 4, marginTop: 4 } as any,
    ...
    effectIconOverlay: { position: 'absolute', top: 12, right: 12, opacity: 0.9, padding: 4, backgroundColor: 'rgba(0,0,0,0.2)', borderRadius: 12 } as any,
    itemInfoOverlay: {
    ...
    itemName: { fontSize: 13, fontWeight: '700', marginBottom: 2, color: '#1a1a1a', letterSpacing: '-0.3px' } as any,
    textDark: { color: '#fff' } as any,
    itemDesc: { fontSize: 11, color: '#666', marginBottom: 10, height: 28, lineHeight: '14px' } as any,
    buyButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f0f9ff', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 20, alignSelf: 'flex-start', borderWidth: 1, borderColor: '#e0f2fe' } as any,
    buyButtonText: { fontWeight: '700', marginRight: 4, fontSize: 13, color: '#0284c7' } as any,
    coinIconSmall: { width: 14, height: 14 } as any,
    ownedBadge: { position: 'absolute', top: -10, right: 0, backgroundColor: '#22c55e', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, borderWidth: 1, borderColor: '#fff' } as any,
