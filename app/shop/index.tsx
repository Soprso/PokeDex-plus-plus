import { ExtraLoveEffect, GhostlyMistEffect, IcyWindEffect, MagmaStormEffect, NeonCyberEffect, ShineOverlay } from '@/components/card-effects';
                    ...
                    {filteredItems.map(item => {
                        ...
                        return (
                            <View key={item.id} style={[styles.itemCard, isDark && styles.itemCardDark]}>
                                ...
                                <View style={[styles.cardBackground, { backgroundColor: (item.id === 'extra_love' || item.id === 'effect_icy_wind' || item.id === 'effect_magma_storm' || item.id === 'effect_ghostly_mist' || item.id === 'effect_neon_cyber') ? 'transparent' : cardBackground }]}>
                                    {/* Live Effect Preview */}
