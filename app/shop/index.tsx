import { ExtraLoveEffect, GhostlyMistEffect, IcyWindEffect, NeonCyberEffect, ShineOverlay } from '@/components/card-effects';
                    ...
                    {filteredItems.map(item => {
                        ...
                        return (
                            <View key={item.id} style={[styles.itemCard, isDark && styles.itemCardDark]}>
                                ...
                                <View style={[styles.cardBackground, { backgroundColor: (item.id === 'extra_love' || item.id === 'effect_icy_wind' || item.id === 'effect_ghostly_mist' || item.id === 'effect_neon_cyber') ? 'transparent' : cardBackground }]}>
                                    {/* Live Effect Preview */}
                                    ...
                                    <View style={StyleSheet.absoluteFill} pointerEvents="none">
                                        ...
                                        {!['extra_love', 'effect_neon_cyber', 'effect_golden_glory', 'effect_ghostly_mist', 'effect_icy_wind'].includes(item.id) && (
